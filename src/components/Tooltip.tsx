...
export function Tooltip({ content, children }: TooltipProps) {
  ...
  return (
    <div className="relative inline-flex" ref={ref}>
      ...
      {visible && (
        <div className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 w-64 rounded-lg bg-gray-900 text-white text-xs p-3 shadow-xl pointer-events-none">
          {content}
